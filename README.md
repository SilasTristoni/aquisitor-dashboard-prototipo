...
Plataforma full-stack para aquisição industrial de potência e até 16 temperaturas, com sessões rastreáveis, atualização em tempo real, alertas, análise e relatórios. O projeto preserva o protótipo original em `legacy/` e mantém a integração física desacoplada por adaptadores.

## Funcionalidades entregues

- login JWT, hash bcrypt, expiração, rate limit básico e RBAC para Administrador, Operador e Visualizador;
- dashboard em tempo real por WebSocket, indicadores, janela temporal, pausa visual, curvas e mapa térmico de 16 canais;
...
- configuração dos 16 termopares, offset, tipo, cor, localização e limites;
